/*
  ...
  - The values [TECHNOLOGY,HEALTHCARE,FINANCE,EDUCATION,MANUFACTURING,RETAIL,CONSTRUCTION,TRANSPORTATION,ENERGY,AGRICULTURE,TELECOMMUNICATIONS,HOSPITALITY,REAL_ESTATE,MEDIA,CONSULTING] on the enum `SectorEnum` will be removed. If these variants are still used in the database, this will fail.
